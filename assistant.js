...
// 🛡️ ФИКС ИНТЕРВАЛОВ ДЛЯ MEXC (БРАТ, ВОТ ОН СПАСИТЕЛЬ!)
...
async function fetchCandleData(symbol, interval = '15m', limit = 40) {
    try {
        ...
        const mexcInterval = mapMexcInterval(interval); // Исправлено!
...
async function runMarketScan() {
    ...
    for (const id of candidates) {
        ...
        if (candles1h && candles15m) {
            batchData.push({ 
                ...
                h1_full_history: candles1h, 
                m15_full_history: candles15m 
            });
        }
    }
    ...
    try {
        // 🚀 НОВЫЙ ПРОМПТ: SENIOR INSTITUTIONAL RISK MANAGER (v4.5 DEEP LONG-TERM)
        ...
        1. DEEP HTF CHECK: Analyze the last 1000 candles on H1. Identify major Liquidity Pools and Order Blocks from the last 30+ days.
        ...
        Market Data (1000 H1 + 1000 M15 candles): 
...
// 🛡️ ИНТЕРВАЛ ЭКОНОМИИ (v4.5): 480000ms = 8 минут.
