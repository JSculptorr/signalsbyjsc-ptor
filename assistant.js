...
const webpush = require('web-push'); // Добавлен модуль уведомлений

const app = express();
const JWT_SECRET = "jsc-secret-key-unique-2026"; 

// --- НАСТРОЙКА УВЕДОМЛЕНИЙ (VAPID) ---
const VAPID_PUBLIC = "BCR3S-9E_FmSInU3O9S-n3C86vG6zN8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8"; // Публичный ключ
const VAPID_PRIVATE = "8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8"; // Приватный ключ (генерируется один раз)

webpush.setVapidDetails(
    'mailto:support@jsculptor.com',
    "BCfS_o-r2O9Y7_GzS6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y", // Реальные VAPID ключи
