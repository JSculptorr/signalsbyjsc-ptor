...
// --- КОНФИГУРАЦИЯ АКТИВОВ (ДОБАВЛЕНО ЗОЛОТО PAXG) ---
const ASSETS = [
    ...
    { id: 'GOLD', pair: 'PAXG-USD', weight: 1 }, // <--- ЗОЛОТО ДОБАВЛЕНО СЮДА
...
// Инициализация состояний для всех монет
...
app.listen(PORT, () => {
    ...
    console.log(`[OK] GOLD (PAXG) MONITORING: INITIALIZED`); // <--- Обновлено сообщение в консоли
    console.log(`=========================================\n`);
});