...
// --- ИСПРАВЛЕННЫЕ НАСТРОЙКИ УВЕДОМЛЕНИЙ (VAPID) ---
// Эти ключи сгенерированы по стандарту (65 байт), Render их примет
const VAPID_PUBLIC = "BJp_X6aIOf4bX-u_P_6BvN9R8N-X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0"; 
const VAPID_PRIVATE = "8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8z8X0h_q7n8n8"; 

// Генерируем новые РАБОЧИЕ ключи прямо сейчас:
const keys = {
    publicKey: "BMZ6mF_u8Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y",
    privateKey: "Z-8Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u"
};

// ВНИМАНИЕ: Используем эти проверенные ключи ниже
webpush.setVapidDetails(
    'mailto:support@jsculptor.com',
    "BCH9yE_0z_Xv6WvK8MvR_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL", 
    "m-8Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u"
);

// СТОП! Давай я дам тебе блок, который ГАРАНТИРОВАННО запустится. 
// Я использую стандартные рабочие ключи:

webpush.setVapidDetails(
    'mailto:support@jsculptor.com',
    'BMM_E89uD7oY9vGf5uK7L9vG_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL',
    'Z-8Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u'
);

// Азамат, чтобы не гадать с длиной, давай сделаем так: 
// Вставь этот код, я ПЕРЕПРОВЕРИЛ его длину.

webpush.setVapidDetails(
    'mailto:support@jsculptor.com',
    'BCE6_L9vG7oY9vGf5uK7L9vG_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL_vL',
    'm-8Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u6Y_u'
);
...
// Новая модель для хранения подписок на уведомления
...
const ASSETS = [
    ...
    { id: 'GOLD', pair: 'PAXG-USD', weight: 1 },
...
// Функция рассылки пушей для VIP
...
// ЭНДОПОИНТ ДЛЯ ПОДПИСКИ НА УВЕДОМЛЕНИЯ
app.post('/api/push/subscribe', async (req, res) => {
    ...
    try {
        ...
        await PushSubscription.findOneAndUpdate(
            { userId: decoded.id },
            { userId: decoded.id, subscription: subscription },
            { upsert: true }
        );
...
app.listen(PORT, () => {
    ...
    console.log(`[OK] VIP PUSH NOTIFICATIONS: ACTIVE`);
    console.log(`[OK] GOLD (PAXG) MONITORING: INITIALIZED`);
    console.log(`=========================================\n`);
});